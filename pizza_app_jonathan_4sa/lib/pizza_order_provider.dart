...
class PizzaOrderProvider extends InheritedWidget {
  final PizzaOrderBloc bloc; // El BLoC que maneja el estado de la orden de pizza.
  @override
  final Widget child; // El widget hijo que recibirá el bloc a través del árbol de widgets.

  // Constructor de la clase, recibe el bloc y el widget hijo.
  const PizzaOrderProvider({super.key, required this.bloc, required this.child}) : super(child: child);
