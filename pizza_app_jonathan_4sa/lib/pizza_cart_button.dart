...
class PizzaCartButtonState extends State<PizzaCartButton>
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      ...
      duration: const Duration(milliseconds: 150), // Duración de la animación al expandir.
      reverseDuration: const Duration(milliseconds: 200), // Duración de la animación al contraer.
    );
  }
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              begin: Alignment.topCenter, // Gradiente empieza en la parte superior.
              end: Alignment.bottomCenter, // Gradiente termina en la parte inferior.
              colors: [
                Colors.orange.withOpacity(0.5), // Naranja con opacidad para la parte superior.
