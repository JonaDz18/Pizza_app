...
class PizzaSizeButton extends StatelessWidget {
  ...
  final String text; // El texto que representa el tamaño de la pizza (ejemplo: "S", "M", "L")
  final VoidCallback onTap; // Función que se ejecuta cuando el botón es tocado

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 10.0), // Espaciado entre los botones
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: selected // Si el botón está seleccionado, se agrega una sombra
                ? [
                    const BoxShadow(
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight: selected // Si el botón está seleccionado, el texto tiene un peso mayor
                    ? FontWeight.bold
                    : FontWeight.w300, // Peso de la fuente cuando no está seleccionado
              ),
            ),
          ),
        ),
